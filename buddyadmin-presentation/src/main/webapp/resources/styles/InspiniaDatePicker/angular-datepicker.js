...
!function (a) {
    ...
    b.constant("datePickerConfig", {
        ...
        return {
            ...
            scope: {model: "=datePicker", after: "=?", before: "=?"},
            link: function (d, e, f, g) {
                ...
                var k = parseInt(f.step || b.step, 10), l = !!f.partial;
                if (g) {
    ...
    b.directive("dateRange", function () {
        return {
            templateUrl: "templates/daterange.html", scope: {start: "=", end: "="}, link: function (a, b, c) {
    ...
    var c = "ng-pristine", d = "ng-dirty", b = a.module("datePicker");
    b.constant("dateTimeConfig", {
        ...
        var j = e.find("body"), k = f("date");
        return {
            require: "ngModel", scope: !0, link: function (e, f, l, m) {
                function n(a) {
                    return k(a, s)
                }
                ...
                function r() {
                    if (!y) {
                        if (y = b(D)(e), e.$digest(), e.$on("setDate", function (a, b, c) {
                            ...
                            var c = a.extend(f.offset(), {height: f[0].offsetHeight});
                            y.css({top: c.top + c.height, left: c.left, display: "block", position: z}), j.append(y)
